...
//            val joinIntent : Intent = Intent(this,JoinActivity::class.java)
//            launcher.launch(joinIntent)
//
//            // JoinActivity로부터 전달된 인텐트 데이터 받기
//            val receivedId = joinIntent.getStringExtra("joinID") ?: ""
//            val receivedPw = joinIntent.getStringExtra("joinPW") ?: ""
//
//            // 데이터를 UI에 표시
//            binding.idEditText.setText(receivedId)
//            binding.pwEditText.setText(receivedPw)
//        }
        binding.joinTextView.setOnClickListener {
